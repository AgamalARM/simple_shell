...
#include <sys/types.h> /* to type pid */
#include <sys/wait.h> /* to wait */
#include <sys/stat.h> /* to use of stat function */
#include <string.h> /* to strtok*/
#include <stddef.h> /*** to make to gether */
#include <errno.h> /* to errno and perror */
#include <signal.h> /* to signal management */
#include <fcntl.h> /* to open files*/
#include <stdio.h> /* to printf*/
#include <unistd.h> /* to fork, execve*/
#include <stdlib.h> /*** to work to gether */
